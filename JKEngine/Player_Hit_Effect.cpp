...
namespace jk
{
	...
	void Player_Hit_Effect::Initialize()
	{
		...
		at->CreateAnimations(L"..\\Resources\\Texture\\Player\\Effect\\Hit_Skul", this, 0,0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Player\\Effect\\Hit_Skul", this, 1,0.05f);
