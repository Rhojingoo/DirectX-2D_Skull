...
namespace jk
{
	...
	void Stage1_Door::Initialize()
	{
		...
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\Basic_Door", this,0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\Boss_Door", this,0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\GetSkull_Door", this,0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\GetTreasure_Door", this,0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\MiniBoss_Door", this,0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\DarkMarcket", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Open_Door\\Upgrade_Door", this, 0, 0.05f);

		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_Basic_Door", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_Boss_Door", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_DarkMarcket", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_GetSkull_Door", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_GetTreasure_Door", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Close_Door\\Close_MiniBoss_Door", this, 0, 0.05f);
		
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Deactivate_Door\\First", this, 0, 0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\Door\\Stage1\\Deactivate_Door\\Second", this, 0, 0.05f);
