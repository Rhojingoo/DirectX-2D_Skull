...
namespace jk
{
	...
	void Mage_Phoenix_Landing_Land::Initialize()
	{
		...
		at->CreateAnimations(L"..\\Resources\\Texture\\MiniBoss\\Mage\\Effect\\Phoenix_Landing_Land", this,0,0.05f);
		at->CreateAnimations(L"..\\Resources\\Texture\\MiniBoss\\Mage\\Effect\\Phoenix_Landing_Land", this, 1,0.05f);
