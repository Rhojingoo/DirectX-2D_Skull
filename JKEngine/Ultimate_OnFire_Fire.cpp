...
namespace jk
{
	...
	void Ultimate_OnFire_Fire::Initialize()
	{
		...
		at->CreateAnimations(L"..\\Resources\\Texture\\MiniBoss\\Mage\\Effect\\World_On_Fire_Fire", this);
		at->CompleteEvent(L"EffectWorld_On_Fire_Fire") = std::bind(&Ultimate_OnFire_Fire::Compelete, this);

		at->PlayAnimation(L"EffectWorld_On_Fire_Fire", true);
